...
public class UpdateMaintenanceRequestCommandHandler : IRequestHandler<UpdateMaintenanceRequestCommand, ApplicationResult<Guid>>
{
    private readonly IRepository<MaintenanceRequest> _repository;
    private readonly IUnitOfWork _unitOfWork;

    public UpdateMaintenanceRequestCommandHandler(IRepository<MaintenanceRequest> repository, IUnitOfWork unitOfWork)
    {
        _repository = repository;
        _unitOfWork = unitOfWork;
    }

    public async Task<ApplicationResult<Guid>> Handle(UpdateMaintenanceRequestCommand request, CancellationToken cancellationToken)
    {
